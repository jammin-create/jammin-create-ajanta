# jammin + Ajanta SDK Example

This project was created with [jammin](https://github.com/FluffyLabs/jammin), FluffyLabs' toolbox for JAM service builders.

## What is jammin?

Learn more about jammin in the [official documentation](https://fluffylabs.dev/jammin/). This template uses the **Ajanta SDK** for building JAM services.
...
- Pre-configured Ajanta SDK service in `services/example`
...
└── services/
    └── example/        # Your Ajanta SDK service
```
